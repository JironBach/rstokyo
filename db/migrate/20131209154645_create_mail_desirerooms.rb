class CreateMailDesirerooms < ActiveRecord::Migration
  def change
    create_table(:mail_desirerooms, :options => "", :force => (false)) do |t|
      ...
      t.string(:furigana, :limit => 255, :null => (false))
      ...
      t.string(:conditions01, :limit => 255, :null => (false))
      t.string(:conditions02, :limit => 255, :null => (false))
      t.string(:conditions03, :limit => 255, :null => (false))
      t.string(:conditions04, :limit => 255, :null => (false))
      t.string(:conditions05, :limit => 255, :null => (false))
