class CreateMailVacanthouses < ActiveRecord::Migration
  def change
    create_table(:mail_vacanthouses) do |t|
      ...
      t.integer(:master_age_id, :limit => 4)
      t.integer(:master_gender_id, :limit => 4)
      ...
      t.integer(:master_tatemono_class_id, :limit => 4)
      t.boolean(:koshitsu)
      t.integer(:master_live_term_id, :limit => 4)
      t.integer(:master_recruit_gender_id, :limit => 4)
      t.text(:detail)
    end
  end
end
