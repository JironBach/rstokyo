class UpdateAgeToDesireRoom2 < ActiveRecord::Migration
  def change
    ...
    change_column(:mail_desirerooms, :master_commuting_time_id, :integer, :limit => 11, :null => true)
    change_column(:mail_desirerooms, :line, :string, :null => true)
    change_column(:mail_desirerooms, :area, :string, :null => true)
    change_column(:mail_desirerooms, :master_live_term_id, :integer, :limit => 11, :null => true)
    change_column(:mail_desirerooms, :master_desired_number_id, :integer, :limit => 11, :null => true)
